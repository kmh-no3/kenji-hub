      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        {articles.length === 0 && (
          <div className="text-center py-8 sm:py-12 px-4">
            <h2 className="text-xl sm:text-2xl font-bold text-[color:var(--color-fg)] mb-3 sm:mb-4">記事が見つかりません</h2>
            <p className="text-sm sm:text-base text-[color:var(--color-muted)]">現在、公開されている記事はありません。</p>
          </div>
        )}
      </main>
    </div>
