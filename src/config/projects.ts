...
export const projects: Project[] = [
  {
    ...
    description: 'セキュアなパスワードを生成するPWAアプリケーション。WebCrypto APIを使用した安全な乱数生成、パスワード履歴、強度チェック機能を実装。オフライン対応でホーム画面に追加可能。',
  ...
  },
  {
    ...
    description: '複式簿記システムのAPIサーバー。仕訳帳、元帳、試算表の機能を提供し、外部公開を想定したセキュリティ機能を備えている。',
