    ...
    <>
      <header className="bg-white border-b border-gray-200 sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 sm:h-20">
          ...
          <div className="flex items-center space-x-4 sm:space-x-6 lg:space-x-12">
            ...
            <button
              onClick={toggleMenu}
              className="md:hidden p-2 rounded-md text-gray-700 hover:text-blue-600 hover:bg-gray-100 transition-colors z-50 relative"
      ...
      >
        <div className="h-full flex flex-col items-center justify-center">
          ...
          <button
            onClick={closeMenu}
            className="absolute top-6 right-6 p-2 rounded-md text-gray-700 hover:text-blue-600 hover:bg-gray-100 transition-colors"
            aria-label="メニューを閉じる"
          >
