      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 sm:h-20">
        ...
        <div className="flex items-center">
          ...
          <nav className="hidden md:flex space-x-4 lg:space-x-6">
            <strong><span className="text-gray-700 text-sm lg:text-base">ABOUT</span></strong>
            ...
            <strong><Link href="/blog" className="text-gray-700 hover:text-blue-600 transition-colors text-sm lg:text-base">BLOG</Link></strong>
          </nav>
        </div>
